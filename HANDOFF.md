...
- ✅ **link 큐 완주 (18:49 UTC)**: PaperMeister 27편 → done 항목 36, 도판 요청 707 → 답 542, 항목 3,898, skipped 165.
  ...
  둘로 다시 내는 편이 낫다. 큐 페이지: `/figures`. → 클라이언트가 2×20 으로 재제출(09-18 01:32, 잡 `a68bc58f`) → **둘 다 완료**
  (19/20 항목 92 · 20/20 항목 171). **27편 link 전부 끝남** (02:15 UTC). 워커 재시작 후 detect 상한 1200 s 적용됨, 간격 유지 동작 확인.
